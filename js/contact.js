...
---------------------------------------------------*/
(function () {
  emailjs.init("A_OlxOQJm6XQ5PPQ_");
})();
    ...
    $("#contactform").submit(function (e) {
      ...
      document
        ...
        .addEventListener("submit", function (event) {
          ...
          response = emailjs.send("service_qotibe4", "template_b166yss", {
            user_name: document.forms["contactform"]["name"].value,
            message: document.forms["contactform"]["comments"].value,
            subject: "Testing Form",
            user_email: document.forms["contactform"]["email"].value,
          });
        });
